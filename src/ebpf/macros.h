  ...
  // For x86_64, the 4th parameter is in rcx.
  #define PT_REGS_PARM4(ctx) ((ctx)->cx)
#elif defined(__TARGET_ARCH_arm64)
  // For arm64, parameters are in the regs array; parameter 4 is at index 3.
...
#if defined(__TARGET_ARCH_x86)
  // For x86_64, the 2nd parameter is in rsi.
  #define PT_REGS_PARM2(ctx) ((ctx)->si)
#elif defined(__TARGET_ARCH_arm64)
  // For arm64, parameters are in the regs array; parameter 2 is at index 1.
