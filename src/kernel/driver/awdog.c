...
{
    char *argv[] = { "/opt/artisan/bin/ais_manager", (char *)why, NULL }; // incase of emergencies not the plight on society 
    static char *envp[] = {
        "HOME=/",
...
{
    char *argv[] = { "/opt/artisan/bin/ais_welcome", (char *)why, NULL }; // incase of emergencies not the plight on society 
    static char *envp[] = {
        "HOME=/",
        "PATH=/sbin:/bin:/usr/sbin:/usr/bin",
        NULL
